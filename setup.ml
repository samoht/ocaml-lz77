...
(* OASIS_START *)
(* DO NOT EDIT (digest: 7d653a139364c1a6e312c9832043e0fd) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = None;
          synopsis =
            "Pure OCaml implementation of the LZ77 compression algorithm";
          description = None;
          categories = [];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\155 \144ñ~\"\015¾)¸â\159ÞÒý\027";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
